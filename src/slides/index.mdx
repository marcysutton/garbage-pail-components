...
<a href="https://marcysutton.github.io/garbage-pail-components">
  https://marcysutton.github.io/<br />garbage-pail-components
</a>
...
<a href="https://frontendmasters.com/workshops/javascript-accessibility/">
https://frontendmasters.com/<br />workshops/javascript-accessibility
</a>
...
<img src="./no-mouse.png" alt="a crossed-out mouse target" style="max-width:30vh" />
...
> The `<canvas>` element is a bitmap and does not provide information about any drawn objects. Content is not exposed to accessibility tools like semantic HTML is. In general, _avoid canvas in a website or app_.
...
<h1 class="visually-hidden">Speaking of assumptions...</h1>

<a href="https://www.gatsbyjs.org/blog/2019-07-11-user-testing-accessible-client-routing/" title="Go to gatsbyjs.org">
  <img src="./user-testing-fable.jpg" alt="User testing blog post on gatsbyjs.org" />
</a>
...
# Make your Gatsby<br />site accessible

<a href="https://www.gatsbyjs.org/docs/making-your-site-accessible">https://www.gatsbyjs.org/docs/<br />making-your-site-accessible</a>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[@gatsbyjs](https://twitter.com/gatsbyjs)<br />

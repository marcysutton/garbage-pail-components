    ...
    render={data => {
      return (
        <div style={{ height: '1200px', position: 'absolute', width: '100%' }}>
          ...
          <p>
            Doggo ipsum stop it fren borking doggo shoober floofs, very jealous
            pupper thicc. Pats smol borking doggo with a long snoot for pats
            blop pupper, borking doggo wrinkler. Lotsa pats big ol pupper h*ck
            heckin angery woofer pupper, blop heckin mlem.
          </p>
        </div>
      )
    }}
